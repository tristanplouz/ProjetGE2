...
d'alimentation.
	...
	batterie.
		...
		Il est à garder en mémoire que la décharge d'un élément LiPo 
		en-dessous de 2.5V entraîne sa destruction. De manière générale, il 
		est recommandé de ne pas décharger les éléments en-dessous de 3.3V 
		...
		\end{figure}
			...
			caractéristiques principales du modèle de la batterie considérée.
