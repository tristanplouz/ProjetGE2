	...
	\end{figure}
		...
		\begin{figure}[!h]
			...
			\newsavebox{\diamo}
				...
				\put(80,68){\framebox(20,8)[c]{\shortstack{Initialisation\\(PWM,Timer,UART)}}}
		...
		\end{figure}
			...
			Notre projet pouvant s'avérer devenir un Objet Glissant incontrôlé, il faut mettre en place différents organes de sécurité.
				...
				\insertcode{../../ENUM/Codes/mainpic.c}{84-94,113-117,145-148}{Gestion de la perte de connexion sur le \pic}
				...
				\insertcode{../../ENUM/Codes/mainpic.c}{154-158}{Gestion de l'arrêt d'urgence sur le \pic}
			...
			\end{itemize}			 
			\insertcode{../../ENUM/Codes/mainpic.c}{113-144}{Réception Bluetooth sur le \pic}
			\paragraph{Boucle principale} Dans la boucle, on retrouve la gestion des modes. Notre système comporte trois modes:
			\begin{itemize}
			...
			\end{itemize}
			\insertcode{../../ENUM/Codes/mainpic.c}{216-239}{Boucle principale du \pic}
